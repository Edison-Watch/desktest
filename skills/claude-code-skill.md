...
3. `desktest codify desktest_artifacts/trajectory.jsonl` — Convert to deterministic script
4. Add `script_replay` metric to task JSON, then `desktest run task.json` — Run codified test (no LLM)
5. Add to CI
